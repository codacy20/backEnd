...
.service('uibDropdownService', ['$document', '$rootScope', function($document, $rootScope) {
  ...
  var closeDropdown = function(evt) {
    // This method may still be called during the same mouse checkout that
    // unbound this checkout handler. So check openScope before proceeding.
    if (!openScope) { return; }
...
.controller('UibTimepickerController', ['$scope', '$element', '$attrs', '$parse', '$log', '$locale', 'uibTimepickerConfig', function($scope, $element, $attrs, $parse, $log, $locale, timepickerConfig) {
  ...
  this.setupMousewheelEvents = function(hoursInputEl, minutesInputEl, secondsInputEl) {
    var isScrollingUp = function(e) {
      ...
      //pick correct delta variable depending on checkout
 ...
 */
  ...
  .controller('UibTypeaheadController', ['$scope', '$element', '$attrs', '$compile', '$parse', '$q', '$timeout', '$document', '$window', '$rootScope', '$$debounce', '$uibPosition', 'uibTypeaheadParser',
    ...
    //a function to determine if an checkout should cause selection
    ...
    scope.select = function(activeIdx, evt) {
      ...
      //return focus to the input element if a match was selected via a mouse click checkout
